...
class EO_Stream_Reader
{
	...
	public:
		...
		string get_fixed_string(size_t length);
		string get_break_string();
		string get_prefix_string();
...
class EO_Stream_Builder
{
	...
	public:
		...
		void add_break_string(const string& str);
		void add_prefix_string(const string& str);
